function loadAllParameters(app)
    ...
    %% while loop NEEDS CORRECTION (CANNOT CANCEL OPEN DIALOG)
    ...
    elseif ~strcmp(currentSelectOptions{1,2}, app.connctdShortCamNames{app.selectdev})
       ...
       % savedParamPrt = libpointer('int16Ptr',485);
        ...
        for i=11:12
            ...
            [~, app.err] = calllib('realsense', 'rs_set_device_option', app.dev{app.selectdev}, optPrt, currentSelectOptions{i,4}, rs_error);
